...
function generateSticky(item) {
  ...
  const element = `<div  class="card resizable" style="left:${item.position.x}px;top:${item.position.y}px; width: ${item.size.width}px; height: ${item.size.height}px;" data-id=${item.$id}>
...
export { generateSticky, dragSticky, resizeSticky };
